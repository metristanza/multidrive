...
- **Account tokens** — OAuth access tokens are stored locally in your browser (Chrome storage). They never leave your device.
- **License keys** — If you purchase a license, the key is stored locally in your browser.
- **No server storage** — We do not operate servers. No data is transmitted to us.
...
You can:
- **Disconnect accounts** — Remove any Google account from the Extension at any time
- **Revoke access** — Remove the Extension's access via [Google Account Permissions](https://myaccount.google.com/permissions)
- **Uninstall** — Remove the Extension from Chrome, which deletes all locally stored data
